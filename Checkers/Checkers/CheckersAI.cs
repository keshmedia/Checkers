...
currentPieces.Add(new Piece(r, c));
 ...
 {
 if ((currentBoard.GetState(piece.Row - 1,
 piece.Column - 1) == 2) || (currentBoard.GetState(piece.Row - 1,
 piece.Column - 1) == 4))
                {
if (currentBoard.GetState(piece.Row - 2,
piece.Column - 2) == 0)
moves.Add(new Move(new Piece(piece.Row + 1,
 piece.Column), new Piece(piece.Row - 1,
 piece.Column - 2)));
}
if ((currentBoard.GetState(piece.Row - 1,
piece.Column + 1) == 2) || (currentBoard.GetState(piece.Row - 1,
...
piece.Column - 2) == 0)
moves.Add(new Move(new Piece(piece.Row + 1,
piece.Column), new Piece(piece.Row + 3,
piece.Column - 2)));
}
if ((currentBoard.GetState(piece.Row + 1,
piece.Column + 1) == 2) || (currentBoard.GetState(piece.Row + 1,
piece.Column + 1) == 4))
{
 ...
 if (currentBoard.GetState(piece.Row - 1,
     piece.Column - 1) == 0)
     moves.Add(new Move(new Piece(piece.Row + 1,
         piece.Column), new Piece(piece.Row,
         piece.Column - 1)));
 if (currentBoard.GetState(piece.Row - 1,
     piece.Column + 1) == 0)
     moves.Add(new Move(new Piece(piece.Row + 1,
 ...
 if (currentBoard.GetState(piece.Row + 1,
     piece.Column - 1) == 0)
     moves.Add(new Move(new Piece(piece.Row + 1,
         piece.Column), new Piece(piece.Row + 2,
         piece.Column - 1)));
 if (currentBoard.GetState(piece.Row + 1,
     piece.Column + 1) == 0)
     moves.Add(new Move(new Piece(piece.Row + 1,
...
piece.Column + 1)));
   ...
   else if (currentBoard.GetState(piece.Row,
       piece.Column) == 1)
   {
 if ((currentBoard.GetState(piece.Row + 1,
     piece.Column - 1) == 2) || (currentBoard.GetState(piece.Row + 1,
