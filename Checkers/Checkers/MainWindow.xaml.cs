...
CheckersGrid.Children.Remove(stackPanel);
 ...
 redBrush.ImageSource = new BitmapImage(new Uri("Resources/red60p.png", 
     UriKind.Relative));
 var blackBrush = new ImageBrush();
 blackBrush.ImageSource = new BitmapImage(new Uri("Resources/black60p.png", 
     UriKind.Relative));
 switch (r)
 {
 case 1:
 ...
 if ((currentMove.piece1 != null) && (currentMove.piece2 != null))
  ...
  if (CheckMove())
  {
      ...
      aiMakeMove();
        ...
        {
 StackPanel stackPanel1 = (StackPanel)GetGridElement(CheckersGrid, 
 currentMove.piece1.Row, currentMove.piece1.Column);
 StackPanel stackPanel2 = (StackPanel)GetGridElement(CheckersGrid, 
  ...
  if (invalid)
  {
      ...
      return false;
            ...
            if (button1.Name.Contains("Red"))
            {
                ...
                {
  if ((currentMove.isAdjacent("King")) && (!button2.Name.Contains("Black")) 
 && (!button2.Name.Contains("Red")))
      return true;
  Piece middlePiece = currentMove.checkJump("King");
  if ((middlePiece != null) && (!button2.Name.Contains("Black")) 
&& (!button2.Name.Contains("Red")))
  {
   StackPanel middleStackPanel = (StackPanel)GetGridElement(CheckersGrid, 
   middlePiece.Row, middlePiece.Column);
   ...
   if (middleButton.Name.Contains("Black"))
   {
       ...
       return true;
                ...
                {
 if ((currentMove.isAdjacent("Red")) && (!button2.Name.Contains("Black")) 
 && (!button2.Name.Contains("Red")))
     return true;
...
if (jumpMoves.Count > 0)
{
   ...
   && (!button2.Name.Contains("Red")))
   {
       ...
       if (middleButton.Name.Contains("Red"))
       {
           ...
           return true;
                ...
                {
  if ((currentMove.isAdjacent("Black")) && (!button2.Name.Contains("Black")) 
  && (!button2.Name.Contains("Red")))
      return true;
 ...
 return false;
  ...
  if ((currentMove.piece1 != null) && (currentMove.piece2 != null))
            {
 Console.WriteLine("Piece1 " + currentMove.piece1.Row + ", " 
   + currentMove.piece1.Column);
 Console.WriteLine("Piece2 " + currentMove.piece2.Row + ", " 
   + currentMove.piece2.Column);
 StackPanel stackPanel1 = (StackPanel)GetGridElement(CheckersGrid, 
 currentMove.piece1.Row, currentMove.piece1.Column);
 StackPanel stackPanel2 = (StackPanel)GetGridElement(CheckersGrid, 
 currentMove.piece2.Row, currentMove.piece2.Column);
 ...
 else
 {
     ...
     return board;
        ...
        {
StackPanel stackPanel = (StackPanel)GetGridElement(CheckersGrid,
tmpPiece.Row, tmpPiece.Column);
if (stackPanel.Children.Count > 0)
{
 Button button = (Button)stackPanel.Children[0];
 var redBrush = new ImageBrush();
 redBrush.ImageSource = new BitmapImage(new Uri("Resources/red60p_king.png", 
     UriKind.Relative));
 var blackBrush = new ImageBrush();
 blackBrush.ImageSource = new BitmapImage(new Uri("Resources/black60p_king.png", 
     UriKind.Relative));
...
CheckersGrid.Children.Add(stackPanel);
 ...
 if (winner != null)
 {
  ...
  MessageBoxResult result = MessageBox.Show(winner + " is the winner! Would you like to play another?", 
      "Winner", MessageBoxButton.YesNo);
